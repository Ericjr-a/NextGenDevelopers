...
$con = mysqli_connect("localhost", "phpmyadmin", "Afari728!a", "myhmsdb");
...
if (isset($_GET["generate_bill"])) {
  ...
  $content .= '
      <br/>
      <h2 align ="center"> NEXTGEN HOSPITAL</h2></br>
...
<head>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> NEXTGEN HOSPITAL </a>
...
<style type="text/css">
  ...
  body {
    padding-top: 50px;
    background: linear-gradient(135deg, #e9f8fe 0%, #fff 100%);
    color: #333;
...
<body style="padding-top:50px; background: linear-gradient(to bottom, #b3e0ff, white);">
  ...
  <div class="container-fluid" style="margin-top:50px;">
        ...
        <div class="tab-content" id="nav-tabContent" style="width: 950px;">
          ...
          <div class="tab-pane fade" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                <?php
                // Assuming your connection and query setup is correct and includes `docFees`
                $con = mysqli_connect("localhost", "phpmyadmin", "Afari728!a", "myhmsdb");
                global $con;

                // Adjust the SELECT query to include docFees
                $query = "SELECT p.doctor, p.ID, p.appdate, p.apptime, p.disease, p.allergy, p.prescription, a.docFees 
            FROM prestb p 
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <form id="paymentForm_<?php echo $row['ID']; ?>" onsubmit="payWithPaystack(event, '<?php echo $row['ID']; ?>')">
                        <input type="email" id="email-address_<?php echo $row['ID']; ?>" placeholder="Email Address" required />
                        <input type="hidden" id="amount_<?php echo $row['ID']; ?>" value="<?php echo $row['docFees'] * 100; ?>" />
    ...
    <div style="position: absolute; top: 15%; right: 25%; width: 200px; z-index: 100;">
      <svg viewBox="0 0 100 20">
        <path d="M0,10 h30 v-8 l10,10 l10,-10 v8 h40" fill="none" stroke="#0056b3" stroke-width="2" />
      </svg>
    </div>



    <div style="position: absolute; top: 15%; right: 5%; width: 80px; height: 220px; z-index: 100;">
    ...
    <div style="position: absolute; bottom: 10%; right: 10%; width: 100px; z-index: 100;">
      <svg viewBox="0 0 32 32">
        <path d="M23.6,3A7.4,7.4,0,0,0,16,8.6,7.4,7.4,0,0,0,8.4,3,7.5,7.5,0,0,0,1,10.4c0,8,14,18,15,18S31,18.4,31,10.4A7.5,7.5,0,0,0,23.6,3Z" fill="#c82333" />
      </svg>
    </div>


    <div style="position: absolute; bottom: 10%; left: 10%; width: 150px; z-index: 100;">
      <svg viewBox="0 0 64 64">
        <path d="M61,32H51V22a3,3,0,0,0-3-3H42V3a3,3,0,0,0-3-3H25a3,3,0,0,0-3,3V19H16a3,3,0,0,0-3,3V32H3a3,3,0,0,0-3,3V61a3,3,0,0,0,3,3H61a3,3,0,0,0,3-3V35A3,3,0,0,0,61,32ZM25,5h14V19H25ZM5,59V35H15V59ZM17,59V35H31V59ZM33,59V35H47V59ZM49,59V35H59V59Z" fill="#28a745" />
      </svg>
    </div>
  ...
  <script>
    function payWithPaystack(e, id) {
      e.preventDefault();
      let handler = PaystackPop.setup({
        key: 'pk_test_97996f249495ad17d903c25127712d1d1ace8d72',
        email: document.getElementById('email-address_' + id).value,
